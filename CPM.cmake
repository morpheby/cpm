...
#
# Define CPM_WRITE_HIERARCHY to write the module dependency hierarchy to disk
# in JSON format. This will become default in the future as command line tools
# will be built to manipulate the hierarchy / cmake files outside of cmake
# script.
#
...
function(CPM_AddModule name)
  ...
  if (DEFINED _CPM_GIT_REPOSITORY)
    ...
    # also removes the post-fix (which it does), we want to do it here as well.
